...
public class WW_AddToWaitlist extends HttpServlet {
  ...
  private boolean updateDatabase(Connection con, PrintWriter out, String waitlist_id, String student_bid, String student_name, String major_minor, String student_class, String explanation)
    throws SQLException
  {
  ...
  private int insert(Connection con, PrintWriter out, String waitlist_id, String student_bid, String student_name, String major_minor, String student_class, String explanation)
    throws SQLException
  {
    try {
