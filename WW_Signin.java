...
public class WW_Signin extends HttpServlet {
    ...
    // Print header and body
        ...
        out.println("<li class='active'><a href="+selfUrl+">Home</a></li>");
    ...
    // Sign up portion
        ...
        out.println("<p class='lead'>Welcome to the alpha version of Walter Waitlist, the Online Waitlist Management System.</p>");
        out.println("<p><a class='btn btn-lg btn-success' href='WW_CreateAccount' role='button'>Sign up today!</a></p>");
        out.println("</div>");
    }
